...
---
## 🌐 PokeWeb - Pokedex App
PokeWeb es una aplicación web  desarrollada con React, TypeScript y Vite, utilizando Bun. La aplicación usa la PokeAPI para mostrar una lista de Pokémon 

## 🖇️ Link Projecte:
https://free-react.vercel.app/
...
├── src/
│   ├── assets/       
        ├── images/  # Imagenes usadas.
│   ├── components/  # Componentes usados. 5
│   ├── css/                  
│   ├── services/             
│   ├── App.css
│   ├── App.tsx
...
Bash
git clone https://github.com/tu-usuario/free-react-app-lossuperninis.git
cd free-react-app-lossuperninis
